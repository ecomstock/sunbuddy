	...
	render() {
		return(
			<Box className="container">
				<Card className="card" square="false">
					<Box className="content">
						<img id="logo" src={logo} />
						<Typography variant="h1">{this.state.city}</Typography>
						<Typography variant="body1">{this.state.day}</Typography>
						<Box id="temperature">
							<Typography variant="body1" color="primary">{this.state.lowTemp}</Typography>
							<Typography variant="h2">{this.state.currentTemp}</Typography>
							<Typography variant="body1">{this.state.highTemp}</Typography>
						</Box>
						<Condition
							className={this.classes.condition}
